...
public class Map {
	...
	final Airport airportWa = new Airport(60, 60, "Wa", 0, 1);
	final Airport airportWr = new Airport(270, 50, "Wr", 1, 1);
	final Airport airportLu = new Airport(170, 140, "Lu", 2, 1);
	final Airport airportPo = new Airport(160, 30, "Po", 3, 1);
